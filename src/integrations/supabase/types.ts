    ...
    Tables: {
      ...
      cancer_cases: {
        Row: {
          ...
          antecedents_familiaux_details: string | null
          ...
          diagnostic_hemato: string | null
          diagnostic_hemato_code: string | null
          examens_complementaires: string | null
          expositions_professionnelles: string | null
          grade: string | null
          id: string
          imc: number | null
          is_hemopathie: boolean
